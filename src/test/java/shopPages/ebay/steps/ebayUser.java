...
public class ebayUser {
    ...
    public void order_resuls_as_a_list(){
        resultPage.changeResulsOrder2List();
    }

    @Step("#actor filter by specific brand: {0}")
    public void filter_by_specific_brand(String brand) throws InterruptedException {
    ...
    public void print_the_result_count(){
        System.out.println(resultPage.getResultCount());
    }
